...
import { usePerspective, Perspective } from "@/providers/PerspectiveProvider";
...
const perspectives: {
...
}[] = [
  {
    ...
    label: "Red Team",
    color:
      "text-red-500 hover:bg-red-500/10 data-[active=true]:bg-red-500/20 data-[active=true]:text-red-500",
  },
  {
    value: "neutral",
    icon: Eye,
    label: "Neutral",
    color:
      "text-muted-foreground hover:bg-accent data-[active=true]:bg-accent data-[active=true]:text-foreground",
  },
  {
    value: "blue-team",
    icon: Shield,
    label: "Blue Team",
    color:
      "text-blue-500 hover:bg-blue-500/10 data-[active=true]:bg-blue-500/20 data-[active=true]:text-blue-500",
  },
];
...
export function PerspectiveToggle({
  ...
  const buttonSize =
    size === "sm" ? "h-8 px-2" : size === "lg" ? "h-11 px-4" : "h-9 px-3";
